...
export interface WorkspaceApi {
  ...
  /**
   * Permanently deletes every Session assigned to one Workspace, then removes
   * its registration. The directory and user files remain untouched. An
   * unknown id fails with `workspace-not-found`; a Session owned outside this
   * API proxy fails with `session-active`.
   */
  ...
  /** Permanently delete one stopped persisted session and all registry references. */
