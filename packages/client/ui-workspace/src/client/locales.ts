...
export const zh = {
  ...
  'delete.desc': '将删除工作区“{name}”及其中的所有会话记录。工作区文件夹、项目文件与代理创建的文件会保留。',
  'delete.pending': '正在删除工作区…',
  'menu.fork': '分叉会话',
  'menu.archiveSession': '归档会话',
  'delete.session': '删除会话',
  'delete.session.desc': '将永久删除会话“{name}”的记录，并从所有工作区和归档中移除。项目文件与代理创建的文件会保留。',
...
export const en = {
  ...
  'delete.desc': 'This deletes workspace “{name}” and all of its session logs. The workspace folder, project files, and agent-created files will be kept.',
  'delete.pending': 'Deleting workspace…',
  'menu.fork': 'Fork session',
  'menu.archiveSession': 'Archive session',
  'delete.session': 'Delete session',
  'delete.session.desc': 'This permanently deletes the record for “{name}” and removes it from every workspace and archive. Project files and files created by the agent are kept.',
