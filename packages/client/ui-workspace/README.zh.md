...
- **没有取消归档控件**：已归档会话没有查看或取消归档入口，因此删除操作仅在已停止的 Session 仍可见时提供。
