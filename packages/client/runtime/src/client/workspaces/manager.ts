...
export class WorkspaceManager {
  ...
  /**
   * Permanently delete one stopped session through the workspace owner.
   * @param sessionId - Persisted session to delete.
   * @returns The wire result confirming deletion or describing the refusal.
   */
