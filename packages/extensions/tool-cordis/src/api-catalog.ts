  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Permanently remove one persisted session and only artifacts owned by this persistence provider. Live sessions are rejected by the shared coordinator; absent ids reject with SessionPersistenceNotFoundError.',
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Permanently delete one persisted session, then remove every workspace membership and archive entry. A durable pending marker lets startup finish the registry cleanup if the two stores are interrupted between writes.',
        parameters: [{ name: 'sessionId', description: 'Persisted, non-live session id to remove.' }],
...
export const EVENT_API: readonly EventApiEntry[] = [
  ...
  },
  {
    ...
    summary: 'One stopped persisted session was permanently removed.',
    description: 'One stopped persisted session was permanently removed.',
    parameters: [{ name: 'sessionId', description: 'Removed session id.' }],
  },
]
